...
const PermissionSection = ({ title, items, showAddButton, sectionPermissions, onToggle }) => (
...
const RolesPermissions = ({ onCancel, onSave, onAssign }) => {
  const sections = [
    { title: "Users", items: ["View Users", "Edit Users", "Assign Roles", "Deactivate Users"], showAdd: true },
    { title: "Operations", items: ["Services management", "Appointments + Walk-ins", "Calendar"] },
    { title: "People Management", items: ["Users (Staff Account, Volunteers)", "Career/Volunteers"] },
    { title: "Content Management", items: ["Pages", "Page template", "Announcements"] },
    { title: "Volunteer Management", items: ["Availability", "Volunteer schedules", "Hours approval"] },
    { title: "Marketing & Engagement", items: ["Coupons management", "Donations / Give settings"] },
    { title: "Reports & Logs", items: ["Audit trails (admin only)"] },
    { title: "System Settings", items: ["Organization info", "Contact info", "Logo & branding", "Footer content", "Roles & permissions"] }
  ];
  ...
  const [userPermissions, setUserPermissions] = useState(() => {
    ...
    sections.forEach(sec => {
      ...
      sec.items.forEach(item => {
        initialState[sec.title][item] = { view: true, create: false, edit: false, delete: false };
      });
    });
    return initialState;
  });
