        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full p-3 border border-gray-300 rounded-xl bg-white text-gray-500 outline-none"
              >
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="">
                  Services (choose a service from dropdown)
                </option>
              </select>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="number"
                name="usageLimit"
                placeholder="1 (Total number of times coupon can be used)"
                onChange={handleChange}
                className="w-full p-3 border border-gray-300 rounded-xl bg-white outline-none"
              />
            </div>
            ...
            <div className="space-y-1.5 relative flex items-center">
              <label className="block text-[14px] font-bold text-gray-800 absolute -top-3.5 left-0">
                Start Date
              </label>
              <input
                type="date"
                name="startDate"
                onChange={handleChange}
                className="w-full p-3 border border-gray-300 rounded-xl bg-white outline-none block pr-10 
               [&::-webkit-calendar-picker-indicator]:opacity-0"
              />
              <img
                src={CalendarIconImg}
                alt="calendar"
                className="absolute right-3.5 top-3.5 w-5 h-5 pointer-events-none object-contain"
              />
            </div>
            {/* End Date */}
            <div className="space-y-1.5 relative flex items-center">
          ...
          <div className="flex justify-center gap-6 pt-6">
            <button
              type="button"
              onClick={onClose}
              className="px-16 py-3 bg-[#0055A5] text-white rounded-lg font-bold"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-16 py-3.5 bg-[#D32F2F] text-white rounded-lg font-bold"
            >
              Submit
            </button>
          </div>
